  ...
  useEffect(() => {
    const fetchDisasterData = async () => {
      try {
        ...
        console.log("Disaster Data:", disasterResponse.disaster);

        if (disasterResponse.disaster && disasterResponse.disaster.address) {
          const address = disasterResponse.disaster.address;
          const mapboxAccessToken = "pk.eyJ1IjoiaGFyc2hzaW5kaHUwNDAyIiwiYSI6ImNsbXozZW9qcjB2OHYya256eDh6djNtazUifQ.LHW2WOgKj04bIqUNJuAzVw"; // Replace with your Mapbox token
          ...
          try {
            ...
            if (geocodingData.features && geocodingData.features.length > 0) {
              setCoordinates(geocodingData.features[0].center);
            } else {
              console.error("Address not found by Mapbox Geocoding API.");
              setCoordinates(null);
            }
  ...
  return (
    <div className="sm:w-full md:w-11/12 mx-auto mt-4">
      ...
      {loadingData ? (
        ...
        <div className="flex flex-col md:flex-row gap-6 bg-white shadow-2xl p-6 rounded-lg">
